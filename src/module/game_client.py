...
# else:
# from src.module import procent, width, height, log, fix_import, d, BASE_FONT
...
enemy = pygame.transform.scale(
    enemy_png, ((enemy_png.get_width() * procent), (enemy_png.get_height() * procent))
)
...
bonus = pygame.transform.scale(
    bonus_jpg, ((bonus_jpg.get_width() * procent), (bonus_jpg.get_height() * procent))
)
...
def get_fps(
    font: pygame.font.Font = BASE_FONT,
